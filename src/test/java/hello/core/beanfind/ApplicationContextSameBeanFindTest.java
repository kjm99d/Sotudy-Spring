...
public class ApplicationContextSameBeanFindTest {
    ...
    void findBeanByTypeDuplicate()
    {
        ...
        Assertions.assertThrows(NoUniqueBeanDefinitionException.class,
                ()-> ac.getBean(IMemberRepository.class));
    }
    ...
    void findBeanByName()
    {
        IMemberRepository memberRepository = ac.getBean("memberRepository1", IMemberRepository.class);
        assertThat(memberRepository).isInstanceOf(IMemberRepository.class);
    }
